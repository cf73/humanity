...
description:
  -
    ...
    content:
      -
        type: text
        text: 'This is the speech (attached below) in which the former Secretary of State outlined a program of economic assistance to war-torn Europe. Mr Marshall is the '
      -
        type: text
        marks:
          -
