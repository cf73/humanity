...
description:
  -
    ...
    content:
      -
        type: text
        text: 'Ms Le Guin (1929 - 2018) was, "sane, committed, annoyed, humorous, wise and always intelligent." (The Guardian)'
  -
    type: paragraph
    content:
      -
...
transcript:
  ...
  -
    ...
    content:
      -
        type: text
        text: 'And as further apology for our unsuccessful research, here, courtesy of Maria Popova, is another bonus track:  '
      -
        type: text
        marks:
          -
            type: link
            attrs:
              href: 'https://www.themarginalian.org/2014/10/17/ursula-k-le-guin-gender/'
              rel: null
              target: _blank
              title: null
        text: "Ms. Le Guin's spectacular original take on being a man"
      -
        type: text
        text: ', of all things.'
  -
