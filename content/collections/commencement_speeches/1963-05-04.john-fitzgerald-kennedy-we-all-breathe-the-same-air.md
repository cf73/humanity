...
description:
  -
    ...
    content:
      -
        type: text
        text: 'JFK believed that world peace is possible, not just necessary.'
  -
    type: paragraph
    content:
      -
    ...
    content:
      -
        ...
        marks:
          -
            type: bold
        text: "First:\_Let us examine our attitude toward peace itself."
      -
        type: text
        text: " Too many of us think it is impossible. Too many think it unreal. But that is a dangerous, defeatist belief. It leads to the conclusion that war is inevitable, that mankind is doomed, that we are gripped by forces we cannot\_control."
  -
    type: paragraph
    content:
      -
