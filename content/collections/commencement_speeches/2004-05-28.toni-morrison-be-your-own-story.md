...
transcript:
  ...
  -
    ...
    content:
      -
        type: text
        text: "N.B.\_This speech has been published as a book, as reviewed in "
      -
        type: text
        marks:
          -
  ...
  -
    ...
    content:
      -
        type: text
        text: "Bonus track, Ms. Morrison's Nobel acceptance speech: "
      -
        type: text
        marks:
          -
            type: italic
        text: '"But who does not know of literature banned because it is interrogative; discredited because it is critical; erased because alternate? And how many are outraged by the thought of a self-ravaged tongue?'
      -
        type: text
        text: '"'
  -
      ...
      -
        ...
        marks:
          -
            type: link
            attrs:
              href: 'https://www.youtube.com/watch?v=ticXzFEpN9o&t=12s'
              rel: null
              target: null
              title: null
        text: 'https://www.youtube.com/watch?v=ticXzFEpN9o&t=12s'
challenges:
  - democracy
  - war
  - climate
updated_by: 46c097c5-771c-49e2-b8c6-ba6009ae7172
updated_at: 1737711100
description:
  -
    type: paragraph
    content:
      -
        type: text
        text: 'In many ways, Toni Morrison gives the anti-address. Not only does she dispense with the clichés and platitudes we hear in so many commencement addresses, but she tells us why they are entirely inappropriate for the occasion. "'
      -
        type: text
        marks:
          -
...
video_id: 'wVFRjT-Jfec?si=mh-wfCq-vwaAQNFU'
